...
{
    public partial class RptTransportOrders : System.Web.UI.Page
    {
        ...
        private void RendeReport()
        {
            ...
            ReportViewer1.LocalReport.ReportEmbeddedResource = string.Format("adesoft.adeposx.report.Reports.RptTransportOrders.rdlc", RptOpt);
